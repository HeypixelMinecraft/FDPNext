...
abstract class Command(val command: String, val alias: Array<String>) : MinecraftInstance() {
     ...
     */
    protected fun chatSyntax(syntax: String) = ClientUtils.displayAlert("Syntax: §7${FDPNext.commandManager.prefix}$syntax")
    ...
    protected fun chatSyntax(syntaxes: Array<String>) {
        ...
        for (syntax in syntaxes)
            ClientUtils.displayChatMessage("§8> §7${FDPNext.commandManager.prefix}$command ${syntax.lowercase()}")
    }
