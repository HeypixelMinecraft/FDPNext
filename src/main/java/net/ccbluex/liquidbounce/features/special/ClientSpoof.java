...
public class ClientSpoof extends MinecraftInstance implements Listenable {
    ...
    public void handle(final PacketEvent event) {
        ...
        final net.ccbluex.liquidbounce.features.module.modules.client.ClientSpoof clientSpoof = FDPNext.moduleManager.getModule(net.ccbluex.liquidbounce.features.module.modules.client.ClientSpoof.class);
