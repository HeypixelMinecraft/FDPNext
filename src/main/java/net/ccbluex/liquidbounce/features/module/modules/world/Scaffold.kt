...
class Scaffold : Module(name = "Scaffold", category = ModuleCategory.WORLD, keyBind = Keyboard.KEY_V) {
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (towerStatus || mc.thePlayer.isCollidedHorizontally) {
            ...
            when (sameYValue.get().lowercase()) {
                ...
                "whenspeed" -> {
                    canSameY = FDPNext.moduleManager[Speed::class.java]!!.state
                }
                else -> {
                    canSameY = false
                }
    ...
    fun onMotion(event: MotionEvent) {
        ...
        FDPNext.moduleManager[StrafeFix::class.java]!!.applyForceStrafe(!rotationsValue.equals("None"), moveFixValue.get())
    }
