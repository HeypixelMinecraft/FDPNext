...
abstract class FlyMode(val modeName: String) : MinecraftInstance() {
    ...
    protected val fly: Fly
        get() = FDPNext.moduleManager[Fly::class.java]!!
    ...
    fun sendLegacy() {
        ...
        FDPNext.hud.addNotification(Notification("Fly", "This bypass is for an outdated anti cheat version!", NotifyType.WARNING, 1000))
    }
