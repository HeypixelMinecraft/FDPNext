...
class ModuleManager : Listenable {
    ...
    fun registerModules() {
        ...
        FDPNext.eventManager.registerListener(AutoDisable)
    ...
    fun registerModule(module: Module) {
        ...
        FDPNext.eventManager.registerListener(module)
    }
    ...
    fun unregisterModule(module: Module) {
        ...
        FDPNext.eventManager.unregisterListener(module)
    }
    ...
    internal fun generateCommand(module: Module) {
        ...
        FDPNext.commandManager.registerCommand(ModuleCommand(module, values))
    }
    ...
    private fun onKey(event: KeyEvent) {
        if (pendingBindModule == null) {
            ...
            FDPNext.hud.addNotification(Notification("KeyBind", "Bound ${pendingBindModule!!.name} to ${Keyboard.getKeyName(event.key)}.", NotifyType.INFO))
