...
object Insult : Module(name = "Insult", category = ModuleCategory.MISC) {
    ...
    private val insultFile = File(FDPNext.fileManager.dir, "insult.json")
    ...
    fun loadFile() {
        ...
        try {
            ...
            if (!insultFile.exists()) {
                FileUtils.unpackFile(insultFile, "assets/minecraft/FDPNext/misc/insult.json")
            }
            // read it
