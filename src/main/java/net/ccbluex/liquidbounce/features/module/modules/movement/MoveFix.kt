...
class MoveFix : Module("MoveFix", category = ModuleCategory.MOVEMENT) {
    ...
    private fun getBloxdMoveVec(forwardIn: Float, strafeIn: Float, speed: Double): MutableVec3d {
        val player = mc.thePlayer ?: return MutableVec3d(0.0, 0.0, 0.0)
        ...
        if (sqrt >= 0.01f) {
            ...
            return MutableVec3d(0.0, 0.0, 0.0)
        }
