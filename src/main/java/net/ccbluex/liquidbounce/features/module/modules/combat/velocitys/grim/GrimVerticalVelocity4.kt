...
/**
 * Skidded from edFDP GrimVerticalVelocity4.
 * Like V1 but conditions only require isSprinting + serverSprintState (no moveForward check).
 * motionX/Z *= 0.07776
 */
class GrimVerticalVelocity4 : VelocityMode("GrimVertical4") {
