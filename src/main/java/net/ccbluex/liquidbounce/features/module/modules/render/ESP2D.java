...
public final class ESP2D extends Module {
    ...
    public static boolean shouldCancelNameTag(EntityLivingBase entity) {
        return FDPNext.moduleManager.getModule(ESP2D.class) != null && FDPNext.moduleManager.getModule(ESP2D.class).getState() && FDPNext.moduleManager.getModule(ESP2D.class).tagsValue.get() && collectedEntities.contains(entity);
    }
