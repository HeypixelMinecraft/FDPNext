...
abstract class LongJumpMode(val modeName: String) : MinecraftInstance() {
    ...
    protected val longjump: LongJump
        get() = FDPNext.moduleManager[LongJump::class.java]!!
    ...
    fun sendLegacy() {
        ...
        FDPNext.hud.addNotification(Notification("LongJump", "This bypass is for an outdated anti cheat version!", NotifyType.WARNING, 1000))
    }
