...
class ComboOneHit : Module(name = "ComboOneHit", category = ModuleCategory.COMBAT) {
    ...
    fun onAttack(event: AttackEvent) {
        ...
        if (onlyAuraValue.get() && !FDPNext.moduleManager[KillAura::class.java]!!.state && !FDPNext.moduleManager[InfiniteAura::class.java]!!.state) return
