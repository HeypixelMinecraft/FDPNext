...
class KillAura : Module(name = "KillAura", category = ModuleCategory.COMBAT, keyBind = Keyboard.KEY_G) {
    ...
    override fun onDisable() {
        FDPNext.moduleManager[TargetStrafe::class.java]!!.doStrafe = false
        currentTarget = null
        hitable = false
        packetSent = false
    ...
    fun onUpdate(ignoredEvent: UpdateEvent) {
        ...
        FDPNext.moduleManager[TargetStrafe::class.java]!!.targetEntity = currentTarget?:return

        FDPNext.moduleManager[StrafeFix::class.java]!!.applyForceStrafe(rotationStrafeValue.equals("Silent"), !rotationStrafeValue.equals("Off") && !rotationModeValue.equals("None"))
    ...
    private fun updateTarget() {
        ...
        for (entity in discoveredTargets) {
            ...
            if (mc.thePlayer.getDistanceToEntityBox(entity) < discoverRangeValue.get()) {
                ...
                FDPNext.moduleManager[TargetStrafe::class.java]!!.targetEntity = currentTarget?:return
                FDPNext.moduleManager[TargetStrafe::class.java]!!.doStrafe = FDPNext.moduleManager[TargetStrafe::class.java]!!.toggleStrafe()
                return
            }
        }
    ...
    private val cancelRun: Boolean
        get() = mc.thePlayer.isSpectator || !isAlive(mc.thePlayer)
                || (blinkCheck.get() && FDPNext.moduleManager[Blink::class.java]!!.state) || FDPNext.moduleManager[FreeCam::class.java]!!.state ||
                (noScaffValue.get() && FDPNext.moduleManager[Scaffold::class.java]!!.state) || (noFlyValue.get() && FDPNext.moduleManager[Fly::class.java]!!.state) || (noInventoryAttackValue.equals("CancelRun") && (mc.currentScreen is GuiContainer ||
                    System.currentTimeMillis() - containerOpen < noInventoryDelayValue.get()))
