...
class NoSlow : Module(name = "NoSlow", category = ModuleCategory.MOVEMENT) {
    ...
    private val isBlocking: Boolean
        get() = (mc.thePlayer.isUsingItem || FDPNext.moduleManager[KillAura::class.java]!!.blockingStatus) && mc.thePlayer.heldItem != null && mc.thePlayer.heldItem.item is ItemSword
