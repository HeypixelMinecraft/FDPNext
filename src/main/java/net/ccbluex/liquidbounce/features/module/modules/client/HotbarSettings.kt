    ...
    fun onRender2D(event: Render2DEvent) {
        ...
        when {
            hotbarValue.get() == "Win11" -> {
                ...
                RenderUtils.drawImage( ResourceLocation("FDPNext/ui/hotbar/win11.png"), sr.scaledWidth / 2 - 95, sr.scaledHeight - 19, 14, 14)
                // date and time
                ...
                // fake icons
                RenderUtils.drawImage(ResourceLocation("FDPNext/ui/hotbar/1.png"), (sr.scaledWidth - padding) - 10, sr.scaledHeight - 17, 10, 10)
                RenderUtils.drawImage(ResourceLocation("FDPNext/ui/hotbar/2.png"), (sr.scaledWidth - padding) - 28, sr.scaledHeight - 17, 10, 10)
                RenderUtils.drawImage(ResourceLocation("FDPNext/ui/hotbar/3.png"), (sr.scaledWidth - padding) - 46, sr.scaledHeight - 17, 10, 10)
                // lang idicator
                ...
                RenderUtils.drawImage(ResourceLocation("FDPNext/ui/hotbar/up.png"), (sr.scaledWidth - paddingAfter) - 68, sr.scaledHeight - 17, 10, 10)
            }
