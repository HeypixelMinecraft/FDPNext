...
/**
 * Skidded from edFDP GrimVerticalVelocity3.
 * No preconditions on sprint state; jumps on ground; motionX/Z *= 0.0 (full cancel).
 */
class GrimVerticalVelocity3 : VelocityMode("GrimVertical3") {
