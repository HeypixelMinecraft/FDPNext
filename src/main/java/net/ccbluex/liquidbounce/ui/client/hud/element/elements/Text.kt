    ...
    private fun getReplacement(str: String): String? {
        if (mc.thePlayer != null) {
            when (str) {
                ...
                "attackDist" -> return if (FDPNext.combatManager.target != null) mc.thePlayer.getDistanceToEntity(FDPNext.combatManager.target).toString() + " Blocks" else "Hasn't attacked"
            }
        }
        ...
        return when (str) {
            ...
            "clientName" -> FDPNext.CLIENT_NAME
            "clientVersion" -> FDPNext.CLIENT_VERSION
            "clientCreator" -> FDPNext.CLIENT_CREATOR
