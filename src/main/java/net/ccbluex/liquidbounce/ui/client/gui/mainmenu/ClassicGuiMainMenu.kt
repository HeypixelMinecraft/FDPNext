...
class ClassicGuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        mc.fontRendererObj.drawCenteredString(FDPNext.CLIENT_NAME, (width / 2).toFloat(), (bHeight - 20).toFloat(), Color.WHITE.rgb, false)
        mc.fontRendererObj.drawString(FDPNext.CLIENT_VERSION, 3F, (height - mc.fontRendererObj.FONT_HEIGHT - 2).toFloat(), 0xffffff, false)
        "§cWebsite: §fhttps://${FDPNext.CLIENT_WEBSITE}/".also { str ->
