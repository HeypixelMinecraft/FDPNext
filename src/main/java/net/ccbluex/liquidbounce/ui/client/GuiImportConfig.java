...
public class GuiImportConfig extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float delta) {
        ...
        FontLoaders.F18.drawString(FDPNext.CLIENT_NAME,10,10,new Color(255,255,255).getRGB());
        final int h;
        ...
        FontLoaders.F14.drawString("Tips: FDPNext", (float) ((1-aaa[0])*(18))+4, this.height / 2 + 50, new Color(189, 189, 189).getRGB());
