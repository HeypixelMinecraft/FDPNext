...
public class SlightUI extends GuiScreen implements GuiYesNoCallback {
    ...
    public static Module currentModule = (Module) FDPNext.moduleManager.getModuleInCategory(currentModuleType).get(0);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawImage(new ResourceLocation("FDPNext/ui/clickgui/slight/background.png"), 0, 0, (int) ((float) sr.getScaledWidth() * (1.0F / scale)), (int) ((float) sr.getScaledHeight() * (1.0F / scale)));
        ...
        for (m = 0; m < ModuleCategory.values().length; ++m) {
            ...
            try {
                if (this.isCategoryHovered(startX - 40.0F, startY + 20.0F + (float) (m * 30), startX + 60.0F, startY + 45.0F + (float) (m * 40), mouseX, mouseY) && Mouse.isButtonDown(0) && !this.MIND) {
                    ...
                    currentModule = FDPNext.moduleManager.getModuleInCategory(currentModuleType).size() != 0 ? (Module) FDPNext.moduleManager.getModuleInCategory(currentModuleType).get(0) : null;
        ...
        if (this.isCategoryHovered(startX + 60.0F, startY, startX + 200.0F, startY + 235.0F, mouseX, mouseY) && !this.MIND) {
            if (m < 0 && this.moduleStart < (float) (FDPNext.moduleManager.getModuleInCategory(currentModuleType).size() - 1)) {
                ++this.moduleStart;
        ...
        if (currentModule != null) {
            ...
            for (font = 0; font < FDPNext.moduleManager.getModuleInCategory(currentModuleType).size(); ++font) {
                Module value = (Module) FDPNext.moduleManager.getModuleInCategory(currentModuleType).get(font);
