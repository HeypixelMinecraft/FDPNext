...
public class MainScreen implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : Main.getModulesInCategory(category, FDPNext.moduleManager).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {
