...
public class Module {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        HUD hud = (HUD) FDPNext.moduleManager.getModule(HUD.class);
            ...
            switch (mouseButton) {
                ...
                case 1:
                    if (!module.getValues().isEmpty()) {
                        final ClickGUIModule clickGUI = (ClickGUIModule) FDPNext.moduleManager.getModule(ClickGUIModule.class);
