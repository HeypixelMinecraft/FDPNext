...
public class ModernGuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        try {
            ...
            RenderUtils.drawImage(new ResourceLocation("FDPNext/background.png"), -30, -30, this.res.getScaledWidth() + 60, this.res.getScaledHeight() + 60);
            GlStateManager.translate(-this.currentX / 30.0F, -this.currentY / 15.0F, 0.0F);
            ...
            FontLoaders.F40.drawCenteredString("FDPNext",(float)this.width / 2.0F,(float)this.height / 2.0F - 70.0F,new Color(255,255,255).getRGB());
            ...
            FontLoaders.F40.drawCenteredString("FDPNext",(float)this.width / 2.0F,(float)this.height / 2.0F - 70.0F,new Color(255,255,255).getRGB());
            FontLoaders.F18.drawCenteredString(FDPNext.CLIENT_VERSION,(float)this.width / 2.0F,(float)this.height / 2.0F - 30.0F,new Color(255,255,255).getRGB());
