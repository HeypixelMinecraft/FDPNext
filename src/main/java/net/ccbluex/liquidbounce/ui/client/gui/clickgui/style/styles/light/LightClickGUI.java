...
public class LightClickGUI extends GuiScreen implements GuiYesNoCallback {
    ...
    private Module currentModule = FDPNext.moduleManager.getModuleInCategory(currentCategory).get(0);
...
//        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.drawImage(new ResourceLocation( "FDPNext/ui/clickgui/hud.png"), 9, height - 41, 32, 32);

        // set up bool animations?
        if(!firstSetAnimation) {
            for (Module i : FDPNext.moduleManager.getModules()) {
...
//            hovered = false;
        ...
        //FontManager.logo24.drawCenteredStringWithShadow("ight", startX + 5 + FontManager.logo24.getStringWidth("L") + 8, startY + 8, new Color(255,255,255).getRGB(),255); // 客户端名�?
        ...
        if(searchBox.getText().isEmpty()) {
            if (this.isCategoryHovered(startX + 60, startY + 40, startX + 200, startY + 280, mouseX, mouseY)) {
                if (m < 0 && moduleStart < FDPNext.moduleManager.getModuleInCategory(currentCategory).size() - 8) {
                    moduleStart++;
                }
        ...
        if(!searchBox.getText().isEmpty()) {
            ...
            for(int i = 0; i < FDPNext.moduleManager.getModulesByName(searchBox.getText()).size(); i++) {
                Module module = FDPNext.moduleManager.getModulesByName(searchBox.getText()).get(i);
                if (mY > startY + 280)
                    break;
                if (i < moduleStart) {
                    continue;
        ...
        if (currentModule != null) {
            ...
            float mY = startY + 30;
            if(searchBox.getText().isEmpty()) {
                for (int i = 0; i < FDPNext.moduleManager.getModuleInCategory(currentCategory).size(); i++) {
                    Module module = FDPNext.moduleManager.getModuleInCategory(currentCategory).get(i);
                    if (mY > startY + 280)
                        break;
                    if (i < moduleStart)
                        continue;
        ...
        if (isCategoryHovered(startX - 5, startY + 25, startX + 35 + categoryAnimation, startY + 13 + 45, mouseX, mouseY)) {
            ...
            if (Mouse.isButtonDown(0) && !categoryMouse) {
                if (currentCategory != ModuleCategory.COMBAT) {
                    ...
                    if(searchBox.getText().isEmpty()) {
                        moduleStart = 0;
                        currentModule = FDPNext.moduleManager.getModuleInCategory(currentCategory).get(0);
                        alphaAnim.resetAlpha();
                        valueAnim.resetAlpha();
                    }
                }
        ...
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Combat.png"), (int) startX + 17, (int) startY + 35, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Movement.png"), (int) startX + 17, (int) startY + 70, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/World.png"), (int) startX + 17, (int) startY + 105, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Player.png"), (int) startX + 17, (int) startY + 140, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Exploit.png"), (int) startX + 17, (int) startY + 175, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Misc.png"), (int) startX + 17, (int) startY + 210, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Client.png"), (int) startX + 17, (int) startY + 245, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("FDPNext/ui/clickgui/light/Render.png"), (int) startX + 17, (int) startY + 280, 12, 12);
