...
public class Fonts {
    ...
    public static void loadFonts() {
        ...
        try {
            ...
            final File fontsFile = new File(FDPNext.fileManager.getFontsDir(), "fonts.json");
    ...
    private static Font getFontcustom(int size,String fontname) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/"+fontname+".ttf")).getInputStream();
    ...
    private static Font getFont1(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/icon.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(Font.PLAIN, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont2(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/regular.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(Font.PLAIN, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont3(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/SFBOLD.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(Font.PLAIN, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont4(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/tenacity.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(Font.PLAIN, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFont5(int size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager()
                    .getResource(new ResourceLocation("FDPNext/font/tenacity-bold.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(Font.PLAIN, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static void initSingleFont(String name, String resourcePath) throws IOException {
        File file=new File(FDPNext.fileManager.getFontsDir(), name);
        if(!file.exists())
    ...
    private static Font getFont(final String fontName, final int size) {
        try {
            final InputStream inputStream = new FileInputStream(new File(FDPNext.fileManager.getFontsDir(), fontName));
