...
class Language(val locale: String) {
    ...
    private fun find(): InputStream {
        ...
        if(split.size > 1) {
            ...
            LanguageManager::class.java.classLoader.getResourceAsStream("assets/minecraft/FDPNext/translations/${str}/source.properties")?.let {
                return it
            }
        }
        ...
        LanguageManager::class.java.classLoader.getResourceAsStream("assets/minecraft/FDPNext/translations/source.properties")?.let {
            return it
        }
