...
public class RenderWings extends ModelBase {
    ...
    final Wings Wings = FDPNext.moduleManager.getModule(Wings.class);
    String WingMode = Wings.getWingStyle().get();

    public RenderWings() {
        if(WingMode.equals("Dragon")) { this.location = new ResourceLocation("FDPNext/wings/DragonWings.png"); } else if(WingMode.equals("Simple")) { this.location = new ResourceLocation("FDPNext/wings/NeonWings.png"); }
