...
A super-skid Minecraft client based on FDP v5.3.5, using Minecraft Forge 1.8.9 and mixin injection.
...
FDPNext uses gradle, so make sure that it is installed properly. Instructions can be found on [Gradle's website](https://gradle.org/install/).
...
If you get a "Cannot find Forge Bin" error, download Forge 1.8.9 Universal from [here](https://maven.minecraftforge.net/net/minecraftforge/forge/1.8.9-11.15.1.2318-1.8.9/forge-1.8.9-11.15.1.2318-1.8.9-universal.jar) and place it in `./FDPNext-main/.gradle/minecraft`
